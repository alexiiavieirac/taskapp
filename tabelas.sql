...
DELETE FROM usuario WHERE email = 'thecondor1981@gmail.com';

DELETE FROM tarefa WHERE usuario_id = (
  SELECT id FROM usuario WHERE email = 'vieiralexiac@gmail.com'
);

DELETE FROM usuario WHERE email = 'vieiralexiac@gmail.com';

DELETE FROM tarefa WHERE usuario_id = (
  SELECT id FROM usuario WHERE email = 'lekacvieira@gmail.com'
);

DELETE FROM usuario WHERE email = 'lekacvieira@gmail.com';
